...
public class AddCustomer extends JFrame implements ActionListener{
    ...
    AddCustomer(){
        ...
        String Options[] = {"Passport","Driving License","Voter-id card","Ration card"};
     ...
     public void actionPerformed (ActionEvent ae){
        if(ae.getSource()== add){
            ...
            String query = "insert into driver values('"+id+"', '"+number+"',  '"+name+"', '"+gender+"', '"+country+"','"+room+"', '"+time+"','"+deposit+"')";
    
            String query2 = "update room set availability = 'Occupied' where room number = '"+room+"' ";
            Conn conn =  new Conn();
